<?php
    ...
    $less = new lessc;
    $less->compileFile('less/type-1187.less', 'css/type-1187.css');
...
<head>
    ...
    <script src="<?php echo $url_path ?>/js/chart-column.js"></script>
    ...
    <script src="<?php echo $url_path ?>/js/excanvas.js"></script>
